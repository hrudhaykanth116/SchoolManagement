...
fun MultipleChoiceAnswers(
    ...
    optionState: MultipleChoicesAnswerUIState,
    onStateChanged: (MultipleChoicesAnswerUIState) -> Unit
) {
    ...
    Column() {
        currentOptionsList.forEach { optionUIState: MultipleChoicesAnswerUIState.OptionUIState ->
            AnswerOptionUI(
                modifier = modifier,
